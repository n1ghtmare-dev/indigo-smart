  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        className: "gate",
        sections: [
          ["Статус", "Опубликована 1 из 5. Остальные четыре лежат готовыми черновиками на Хабре — со своими хабами, ключевыми словами и картинками. Выкладывать можно в любые дни и в любом порядке."],
          ...
          ["Порядок остальных", "02 хроника по скриншотам → 03 физика → 05 рендер → 04 архитектура. Вторая самая лёгкая и с пятью кадрами, она собирает аудиторию на технические."]
        ],
        links: [
