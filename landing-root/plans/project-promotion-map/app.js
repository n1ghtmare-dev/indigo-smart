  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        className: "gate",
        sections: [
          ["Статус", "Опубликовано 2 из 7. Остальные пять лежат готовыми черновиками на Хабре: со своими хабами, ключевыми словами, обложками и картинками. Выкладывать можно в любые дни и в любом порядке."],
          ["Что уже вышло", "01 «У моего героя нет здоровья, ключей и очков» — геймдизайн, 28.08.2026. 04 «Правила не знают про Three.js» — архитектура и детерминированные e2e, 28.08.2026."],
          ...
          ["Порядок остальных", "Осталось: 07 скалы над облаками → 02 хроника по скриншотам → 06 дешёвые правки → 03 физика → 05 рендер. Первые три визуальные и лёгкие, они собирают аудиторию на технические."]
        ],
        links: [
          ...
          ["✅ 04 · Опубликовано на Хабре", "https://habr.com/ru/articles/1075550/", "live"],
          ...
          ["Черновик 07 · Скалы над облаками", "https://habr.com/ru/articles/1076098/", "draft"],
