  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        className: "gate",
        sections: [
          ["Статус", "Опубликовано 2 из 6. Остальные четыре лежат готовыми черновиками на Хабре: со своими хабами, ключевыми словами, обложками и картинками. Выкладывать можно в любые дни и в любом порядке."],
          ...
          ["Порядок остальных", "Осталось: 02 хроника по скриншотам → 06 дешёвые правки → 03 физика → 05 рендер. Первые две визуальные и лёгкие, они собирают аудиторию на технические."]
        ],
        links: [
